function [P_intersect,distances,distancesToOrigin] = lineIntersect3D(PA,Si)
% Find intersection point of lines in 3D space, in the least squares sense.
% PA :          Nx3-matrix containing starting point (origin) of N lines
% Si :          Nx3-matrix containing directions of N lines
